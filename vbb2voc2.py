...
def parse_anno_file(vbb_inputdir, seq_inputdir, vbb_outputdir, seq_outputdir, person_types=None):
    ...
    Args:
        vbb_inputdir: vbb file saved pth           //视频的标注文件
        seq_inputdir: seq file saved path            //视频文件
        vbb_outputdir: vbb data converted xml file saved path      //xml文件
        seq_outputdir: seq data converted frame image file saved path  //jpeg文件    
        person_types: list of person type that will be used (total 4 types: person, person-fa, person?, people).
            If None, all will be used:         
    """              
...
def visualize_bbox(xml_file, img_file):
    ...
    #cv2.waitKey(0)
    cv2.imwrite('/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/data/'+os.path.splitext(os.path.basename(img_file))[0]+'lable.jpg',image)


def main():
    #seq_inputdir = "/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/data"
    ...
    #seq_outputdir = "/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/data/imgout"
    #vbb_outputdir = "/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/data/xmlout"
    ...
    xml_file = "/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/Annotations/217642.xml"
    img_file = "/home/user2/chen_guang_hao/PeDetect/smallcorgi/Faster-RCNN_TF-master/data/VOCdevkit2007/Caltech/JPEGImages/217642.jpg"
